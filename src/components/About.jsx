      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>  
          ...
          <p className='py-2 text-gray-600'>
            With a background in hospitality and management, I bring a unique perspective to software development, utilizing my diverse experiences to create innovative and effective solutions. My dedication to software engineering is matched by my enthusiasm for learning and growing in the field, constantly striving to use my skills to the best of my ability.
          </p>
          <p className='py-2 text-gray-600'>
            When I'm not coding, you can find me staying active outdoors, playing sports, or spending quality time with my loved ones. My multifaceted background and interests not only fuel my creativity but also drive me to excel in every project I undertake.
          </p>
          <a href='#projects'>
